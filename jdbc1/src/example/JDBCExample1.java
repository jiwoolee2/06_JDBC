...
public class JDBCExample1 {
	public static void main(String[] args) {
		// 어디서든지 접근 가능한 static영역에 반환형 x 매개변수로는 String배열이들어갈수있다
		...
		try {
			...
			//SQLException e : DB 연결과 관련된 예외 중 최상위 예외
			e.printStackTrace();
		} catch (ClassNotFoundException e) {
			// ojdbc10.jar에서 제공하는
			// OracleDriver 클래스가 없을경우 발생하는 예외
			e.printStackTrace();
